...
<div style="display:flex; justify-content:space-around;")
  <div style="text-align:center;">
    <img src="images/image1.jpg" width="150"><br>
    <p style="color:blue; font-size:14px;">话筒略低于嘴巴，距离嘴巴2-3cm。</p>
  </div>
  
  <div style="text-align:center;">
    <ima src="images/image2.jpg" width="150"><br>
    <p style="color:red; font-size:14px;">录音过程用手碰话筒</p>
  </div>

  <div style="text-align:center;">
    <img src="images/image3.jpg" width="150"><br>
    <p style="color:red; font-size:14px;">话筒距离太远</p>
  </div>

  <div style="text-align:center;">
    <img src="images/image4.jpg" width="150"><br>

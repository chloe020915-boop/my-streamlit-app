...
<div style="border:2px solid #ccc; padding:15px; border-radius:10px;
            background-color:aquamarine; text-align:left; font-size:18px; line-height:1.8;">
  ...
  <span style="color:royalblue;">Ура, это моя утка! 万岁！这是我的鸭子！
...
function speak(){
  let msg = new SpeechSynthesisUtterance(
      "生活就像海洋，只有意志坚强的人，才能到达彼岸。This is an apple. I like Apples. Apples are good for our health. Ура, это моя утка! 万岁！这是我的鸭子！"
  );
